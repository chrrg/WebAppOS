...
(function(){
    ...
    * */
    o.config={//这里需要配置后端的访问路径开始
        version:"/api/v",//访问时的后端访问地址（version）相对于网站根目录
        auth:"/api/a",//后端访问地址（auth）
        check:"/api/c",//后端访问地址（check）
        OSAppId:"7304e2ba4ad4d653334f88544533f937693d9edc",//开机启动的无界面系统应用APPID 必填
        minVersion:0,//打开时发现低于这个版本号在这里会强制升级，以解决自动更新失效的版本（注意不要高于OSAppId的版本号） 默认0
        startAppId:"dea93ba952214d7026b5396eebe0706c06fb2b02",//启动系统应用后启动的应用ID（首屏应用） 必填
        defaultApp:[
            "7859e14f34f1ec000ad81383eb3beb0af66de812"
        ],//默认安装的应用列表 默认[]
        websocket:null,//WebSocket信息 默认null
